...
@NamedQueries({
    ...
    @NamedQuery(name = "Veiculo.listVeiculoByModelo",
            query = "SELECT v FROM Veiculo v WHERE v.modelo = :mod"),
    @NamedQuery(name = "Veiculo.listVeiculoByMarca",
            query = "SELECT v FROM Veiculo v WHERE v.marca = :marc"),
//    @NamedQuery(name = "Veiculo.listVeiculoByCor",
//            query = "SELECT v FROM Veiculo v WHERE v.cor = :cor"),
//    @NamedQuery(name = "Veiculo.listVeiculoByVersao",
//            query = "SELECT v FROM Veiculo v WHERE v.versao = :ver"),
...
//    @NamedQuery(name = "Veiculo.listVeiculoByEixos",
//            query = "SELECT v FROM Veiculo v WHERE v.numeroEixos = :nEixos"),
//    @NamedQuery(name = "Veiculo.listVeiculoByValor",
//            query = "SELECT v FROM Veiculo v WHERE v.valorVeiculo = :valor"),
//    @NamedQuery(name = "Veiculo.listVeiculoByCilindradas",
//            query = "SELECT v FROM Veiculo v WHERE v.cilindradas = :cili"),
//    @NamedQuery(name = "Veiculo.listVeiculoByMarchas",
//            query = "SELECT v FROM Veiculo v WHERE v.numeroMarchas = :marchas"),
//    @NamedQuery(name = "Veiculo.listVeiculoByPotencia",
//            query = "SELECT v FROM Veiculo v WHERE v.potenciaCV = :cv"),
//    @NamedQuery(name = "Veiculo.listVeiculoByAssentos",
//            query = "SELECT v FROM Veiculo v WHERE v.numAssentos = :nAssentos"),
//    @NamedQuery(name = "Veiculo.listVeiculoByMPortas",
//            query = "SELECT v FROM Veiculo v WHERE v.numeroPortas = :nPortas")
